...
public class HeightLightTest {
	...
	private static Analyzer indexAnalyzer = new AnsjAnalyzer(AnsjAnalyzer.TYPE.index_ansj);

	private static Analyzer queryAnalyzer = new AnsjAnalyzer(AnsjAnalyzer.TYPE.index_ansj);
