...
public class ManagerFactory {
    ...
    /** 要加载的类的 classpath */
    public static final String CLASS_PATH = "D:\\workplaces\\mycollection\\web\\WEB-INF\\classes\\";

    /** 实现热加载的类的全名称(包名+类名 ) */
    public static final String MY_MANAGER = "main.java.cn.lmc.collection.javabasic.classloader.MyManager";
